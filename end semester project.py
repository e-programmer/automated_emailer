...
Example = tkinter.Label(window1, text="(Example: Business,Medicine)")
...
infoLabel.grid(row=8, column=2, pady=10)
...
Dropdowninfo.grid(row=9, column=2)
...
I have specialized in {} with a {} GPA from {}. My colleagues have consistently classified me as a {} person. During my career I have developed proven skills such as {} and I hope to leverage these skills at your company.
...
As a {} in {} at {}, I have acquired skills in {}. I currently have a CGPA of {}.
...
""".format(r_title.get(),r_name.get(),pos.get(),infos.get(),years.get(),Major.get(),uni.get(),skills.get(),gpa.get(),s_name.get())
    ...
    def mailer():
        try:
            ...
            text=msg.as_string()
            server.sendmail(sen_email,rec_email,text)
            server.quit()
...
newButton = tkinter.Button(window1, text="Confirm", command=create_window)
newButton.grid(row=16,column=1,pady=20)
